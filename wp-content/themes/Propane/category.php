	...
	<section id="main" role="main" class="row expand clearfix" data-controller="resultsBar">
		<div class="grid-wrap">
			<div class="search-results-bar clearfix">
				<span>Category:</span>
				<?php printf( '<span class="search-words">' . single_cat_title( '', false ) . '</span>' ); ?>
				<!--<span class="search-words"></?php printf( __( 'Category: %s', 'Propane' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></span>-->
